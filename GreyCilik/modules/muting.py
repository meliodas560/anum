...
def mute(update: Update, context: CallbackContext) -> str:
    ...
    if member.can_send_messages is None or member.can_send_messages:
        ...
        return log
    message.reply_text(text=gs(chat.id, "mute_already"))
...
def unmute(update: Update, context: CallbackContext) -> str:
    ...
    if not user_id:
        message.reply_text(
            text=gs(chat.id, "mute_give_user"
        ))
        return ""
    ...
    if member.status in ("kicked", "left"):
        ...
        message.reply_text(text=gs(chat.id, "mute_user_unmute"))
    else:
...
def temp_mute(update: Update, context: CallbackContext) -> str:
    ...
    if not reason:
        message.reply_text(text=gs(chat.id, "mute_invalidtime"))
        return ""
    ...
    try:
        if member.can_send_messages is None or member.can_send_messages:
            ...
            return log
        message.reply_text(text=gs(chat.id, "mute_user_done"))
        ...
        message.reply_text(text=gs(chat.id, "mute_user_failed"))
